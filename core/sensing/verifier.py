    ...
    prompt = [
        {
            ...
            "parts": (
                ...
                "- EXCLUDE radar items that are company names (e.g., 'OpenAI', 'Google', 'Meta')\n"
                "- EXCLUDE radar items that are generic product families without version specifics "
                "(e.g., 'ChatGPT', 'Gemini', 'Claude', 'Copilot')\n"
                "- EXCLUDE radar items that are overly broad categories "
                "(e.g., 'AI', 'Machine Learning', 'Deep Learning', 'LLM')\n"
                "- ONLY keep radar items that name a SPECIFIC technology, model, technique, tool, or framework\n\n"
