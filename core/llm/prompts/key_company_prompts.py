    ...
    return [
        {
            ...
            "parts": (
                ...
                "containing:\n"
                "1. cross_company_summary — a Markdown narrative with this "
                "EXACT structure:\n"
                "   - One paragraph PER analyzed company (2-4 sentences "
                "each). Begin each paragraph with the company name in bold "
                "(e.g. '**Anthropic**: ...'). Summarise that company's most "
                "consequential moves of the period — specific products/"
                "releases, strategic intent, notable metrics.\n"
                "   - A FINAL synthesis paragraph beginning with "
                "'**Across companies**: ...' that compares strategies, "
                "calls out divergent positioning, and flags cross-company "
                "themes (e.g. 'three of five companies announced agent "
                "platforms this week').\n"
                "   - Paragraphs MUST be separated by a blank line (\\n\\n).\n"
                "   - Emit one paragraph per company in the same order they "
                "were analyzed, then the synthesis paragraph last.\n"
                "   - Do NOT use bullet points or headings inside this "
                "field — prose paragraphs only.\n"
