    ...
    return [
        {
            ...
            "parts": (
                ...
                "complementing (not repeating) the metrics. In each bullet, wrap the single "
                "most important phrase, name, or number in **double asterisks** (markdown bold) "
                "to mark it for emphasis — at most ONE emphasis span per bullet.\n"
