    ...
    contents = [
        {
            ...
            "parts": (
                ...
                "- Merge variations into one entry: e.g., 'GPT-4' and 'GPT-4o' → single "
                "entry for the most current version; 'LLaMA 3' and 'LLaMA 3.1' → single entry.\n"
                ...
                "or background (e.g., GPT-2, BERT, Word2Vec, MapReduce).\n"
                "- If an article compares a new model with an older one, only the NEW model "
                ...
                "- NEVER use company/organization names as radar items (e.g., NOT 'OpenAI', "
                "'Google', 'Meta', 'Microsoft', 'Anthropic').\n"
                "- NEVER use generic product family names that are too broad "
                "(e.g., NOT 'ChatGPT', 'Gemini', 'Claude', 'AWS', 'Azure').\n"
                "- Instead, use the SPECIFIC technology: 'GPT-4o', 'Gemini 2.5 Pro', "
                "'Claude Opus 4', 'Amazon Bedrock', etc.\n"
